...
public class Withdraw extends javax.swing.JFrame {
    ...
    public Withdraw(Connection connection, String nomorAkun) {
        initComponents();
        setTitle("Withdraw");
        cn = connection;
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Jumlah withdraw");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 130, 20));
    ...
    private void depositButtonPanel50MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_depositButtonPanel50MouseClicked
        Color selectedColor = new Color(255, 205, 89);
